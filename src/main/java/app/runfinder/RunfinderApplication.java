	...
	public CommandLineRunner runfinderCLR(RunGroupRepository runningGroupRepository,
		...
		return (args) -> {
			...
			runningGroupRepository
					.save(new RunGroup("runningGroup1", LocalDate.of(2024, 12, 30), LocalTime.of(12, 0, 0),
							"Juoksukatu 1", zipcodeRepository.findByZipcode("00100")));
			runningGroupRepository
					.save(new RunGroup("runningGroup2", LocalDate.of(2024, 12, 30), LocalTime.of(12, 0, 0),
							"Juoksutie 2", zipcodeRepository.findByZipcode("02200")));
			runningGroupRepository
					.save(new RunGroup("runningGroup3", LocalDate.of(2024, 12, 30), LocalTime.of(12, 0, 0),
							"Juoksukuja 3", zipcodeRepository.findByZipcode("02300")));
			runningGroupRepository
					.save(new RunGroup("runningGroup4", LocalDate.of(2024, 12, 30), LocalTime.of(12, 0, 0),
